...
loop# Prepare the dataset. We use both the training & test MNIST digits.
batch_size = 64
...
# The ideas behind deep learning are simple, so why should their implementation be painful?t if you need a custom training algorithm, but you still want to benefit from
