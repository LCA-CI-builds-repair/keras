...
# Code snippet in zero_padding1d.py after fixing the CI issue

# Import necessary libraries
import numpy as np
import keras

# Define the input_shape and create the input tensor x
input_shape = (2, 2, 3)
x = np.arange(np.prod(input_shape)).reshape(input_shape)

# Apply ZeroPadding1D layer with padding=2
y = keras.layers.ZeroPadding1D(padding=2)(x)

# Display the output tensor y
print(y)
    Args:
