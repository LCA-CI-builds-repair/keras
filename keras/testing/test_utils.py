...
def get_test_data(
    ...
    """Gen        # Define a list of dictionaries representing test parameter combinations to be passed to `@parameterized.named_parameters`.ates balanced, stratified synthetic test data to train a model on.
