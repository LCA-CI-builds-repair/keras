    ...
    for test_dicts in all_test_dicts:
        ...
        for test_dict in test_dicts:
            for test in tests:
                ...
                new_test_copy = test.copy()
                # Add all the parameters from test_dict if it is not empty
                if test_dict:
                    new_test_copy.update(test_dict)
                new_test_copy["testcase_name"] = testcase_name
                new_tests.append(new_test_copy)
        # Append the new tests to the existing list of tests
